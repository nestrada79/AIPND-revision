...
def print_results(results_dic, results_stats_dic, model, print_incorrect_dogs=False, print_incorrect_breed=False):
    ...
    print("\n\n*** Results Summary for", model.upper(), "***")
    ...
    print(f"Percentage of Correctly Classified Dog Images: {results_stats_dic['pct_correct_dogs']:.2f}%")
    print(f"Percentage of Correctly Classified 'Not-a' Dog Images: {results_stats_dic['pct_correct_notdogs']:.2f}%")
    print(f"Percentage of Correctly Classified Breeds: {results_stats_dic['pct_correct_breed']:.2f}%")
    print(f"Percentage of Match: {results_stats_dic['pct_match']:.2f}%")
    
    # Print incorrectly classified dogs if print_incorrect_dogs is True
    ...
    # Print incorrectly classified dog breeds if print_incorrect_breed is True
    if print_incorrect_breed:
        if results_stats_dic['n_correct_dogs'] != results_stats_dic['n_correct_breed']:
            print("\nINCORRECT Dog Breed Assign
